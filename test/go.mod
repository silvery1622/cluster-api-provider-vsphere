...
replace sigs.k8s.io/cluster-api/test => sigs.k8s.io/cluster-api/test v1.13.0-rc.1
...
require (
	...
	github.com/vmware-tanzu/vm-operator/external/ncp v0.0.0-20260415041850-86db0a258f37 // indirect
